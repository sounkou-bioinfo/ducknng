...
- Added sqllogictest coverage for mTLS manifest roundtrips over NNG TLS, WSS, and the HTTPS frame carrier, plus query-session identity binding over NNG TLS.

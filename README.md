...
notable landed changes, while `docs/design_review_checklist.md` is a
better guide to the main remaining gaps and next implementation slices.
TLS already supports both file-backed and in-memory PEM material through

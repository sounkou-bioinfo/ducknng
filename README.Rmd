...
`ducknng` is a pure C DuckDB extension providing `nanonext`-inspired bindings to the NNG Scalability Protocols. It also includes a small framed RPC layer whose thin versioned envelope carries Arrow IPC or JSON payloads.

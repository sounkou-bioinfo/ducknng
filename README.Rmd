...
`ducknng` is a pure C DuckDB extension that exposes NNG messaging and a small framed RPC layer to SQL. The SQL ergonomics are inspired by [`r-lib/nanonext`](https://github.com/r-lib/nanonext), while the RPC direction is a thin versioned envelope carrying Arrow IPC or JSON payloads.
